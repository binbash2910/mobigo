...
import { sampleWithRequiredData } from '../group-member.test-samples';
...
describe('GroupMember Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.groupMembers()[0]).toEqual(expect.objectContaining({ id: 25116 }));
  });

  describe('trackId', () => {
    it('should forward to groupMemberService', () => {
      const entity = { id: 25116 };
      jest.spyOn(service, 'getGroupMemberIdentifier');
      const id = comp.trackId(entity);
      expect(service.getGroupMemberIdentifier).toHaveBeenCalledWith(entity);
