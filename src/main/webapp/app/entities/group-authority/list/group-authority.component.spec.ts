...
import { sampleWithRequiredData } from '../group-authority.test-samples';
...
describe('GroupAuthority Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [GroupAuthorityComponent],
      providers: [
        provideHttpClient(),
        {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.groupAuthorities()[0]).toEqual(expect.objectContaining({ id: 1264 }));
  });

  describe('trackId', () => {
    it('should forward to groupAuthorityService', () => {
      const entity = { id: 1264 };
