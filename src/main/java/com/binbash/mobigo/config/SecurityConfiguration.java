...
import com.binbash.mobigo.security.*;
import com.binbash.mobigo.web.filter.SpaWebFilter;
        ...
        http
            ...
            .authorizeHttpRequests(authz ->
                ...
                authz
                    ...
                    .requestMatchers(mvc.pattern(HttpMethod.GET, "/api/config")).permitAll()
                    .requestMatchers(mvc.pattern(HttpMethod.POST, "/api/webhooks/campay")).permitAll()
